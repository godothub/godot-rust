...
mod target;
pub use target::{
    DEFAULT_GODOT_API, GODOT_API_ENV, GodotApiVersion, GodotApiVersionError, SUPPORTED_API_TARGETS,
};
...
pub mod native {
    ...
    #[cfg(any(godot_api_version = "4.5", godot_api_version = "4.6"))]
...
#[cfg(all(feature = "bindings", godot_api_version = "4.4"))]
pub use api_snapshots::godot_4_4 as api_snapshot;
#[cfg(all(feature = "bindings", godot_api_version = "4.5"))]
pub use api_snapshots::godot_4_5 as api_snapshot;
#[cfg(all(feature = "bindings", godot_api_version = "4.6"))]
pub use api_snapshots::godot_4_6 as api_snapshot;
#[cfg(all(feature = "bindings", godot_api_version = "4.7"))]
