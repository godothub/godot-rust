...
fn engine_api_coverage_accepts_intentional_raw_pointer_omissions() {
    let report = godot_codegen::EngineApiGenerationReport {
        ...
        unsafe_pointer_virtual_types: vec![godot_codegen::UnsupportedEngineType {
        ...
        unsafe_pointer_types: vec![godot_codegen::UnsupportedEngineType {
