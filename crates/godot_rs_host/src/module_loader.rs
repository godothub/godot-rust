...
struct GenerationInner {
    shutdown: godot_rs_api::abi::AbiModuleShutdownFn,
    context: usize,
    host: usize,
    host_context: usize,
...
impl ModuleGeneration {
    ...
    unsafe fn load_library(
        ...
        let entry = unsafe {
            library
                .get::<godot_rs_api::abi::AbiModuleEntryFn>(MODULE_ENTRY)
        ...
        reserved[godot_rs_api::abi::HOST_API_SLOT_CALL_GODOT_API] =
        ...
        let host = Box::new(HostApiV1 {
            header: godot_rs_api::abi::AbiHeader::new(HostApiV1::MINIMUM_SIZE),
...
mod tests {
    ...
    fn module_api() -> ModuleApiV1 {
        ...
        ModuleApiV1 {
            header: godot_rs_api::abi::AbiHeader::new(ModuleApiV1::MINIMUM_SIZE),
    ...
    fn script_extension_slots_for(uid: &str) -> [usize; 8] {
        ...
        let words = godot_rs_api::abi::encode_resource_uid_words(uid).expect("test UID words");
        [
    ...
    unsafe extern "C" fn get_reload_field(
        ...
        let value = AbiFieldDescriptorV1 {
            ...
            kind: godot_rs_api::abi::AbiFieldKind::Plain,
            options: AbiByteSlice::EMPTY,
            default_value: AbiByteSlice::EMPTY,
            has_default: 0,
            reserved_flags: [0; 3],
            reload: godot_rs_api::abi::AbiReloadPolicy::Persist,
    ...
    unsafe extern "C" fn get_method(_index: u32, output: *mut AbiMethodDescriptorV1) -> AbiStatus {
        ...
        let value = AbiMethodDescriptorV1 {
            ...
            kind: godot_rs_api::abi::AbiMethodKind::Lifecycle,
            lifecycle: godot_rs_api::abi::AbiLifecycleSlot::Ready,
            receiver: godot_rs_api::abi::AbiReceiverKind::Mutable,
            argument_count: 0,
            reserved_flags: 0,
            options: AbiByteSlice::EMPTY,
    ...
    fn node_schema_is_deep_copied_and_validated() {
        ...
        let node = copy_node_schema(
            ...
            [
                ...
                godot_rs_api::abi::encode_node_field_class(class_name.len(), true)
                    .expect("class length"),
            ],
        )
        ...
        assert!(
            copy_node_schema(
                ...
                [
                    ...
                    invalid_path.len(),
                    class_name.as_ptr() as usize,
                    godot_rs_api::abi::encode_node_field_class(class_name.len(), false)
                        .expect("class length"),
                ],
            )
    ...
    fn versioned_method_schema_validates_defaults_and_varargs() {
        ...
        let mut extension = AbiMethodExtensionsV1 {
            ...
            default_arguments: godot_rs_api::abi::AbiMethodDefaultFnSlice {
                ptr: defaults.as_ptr(),
                len: defaults.len(),
            },
            reserved: [0; 4],
