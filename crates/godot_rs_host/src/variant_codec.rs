use godot_rs_api::abi::{ABI_VALUE_OWNED_UTF8, AbiValueType, AbiValueV1};
use godot_rs_api::{
...
mod tests {
    ...
    fn opaque_storage_covers_all_official_math_configurations() {
        ...
        for summary in godot_rs_api::api_snapshot::BUILTIN_SIZES {
            if matches!(
                summary.name,
    ...
    fn rid_storage_is_exactly_eight_bytes_in_every_official_configuration() {
        let sizes = godot_rs_api::api_snapshot::BUILTIN_SIZES
            .iter()
    ...
    fn four_component_transport_matches_standard_precision_layouts() {
        ...
        let values = godot_rs_api::api_snapshot::BUILTIN_SIZES
            .iter()
            .filter(|summary| {
    ...
    fn matrix_transport_matches_standard_precision_layouts() {
        ...
        for (name, size) in expected {
            let summary = godot_rs_api::api_snapshot::BUILTIN_SIZES
                .iter()
