...
macro_rules! host_println {
    ($($argument:tt)*) => {
        crate::logging::module(
            godot_api::abi::AbiLogLevel::Info,
...
pub fn exercise_project_module_callbacks(
    ...
    if signal_arguments
        != [
            ("old_value", godot_api::abi::AbiValueType::I64),
            ("new_value", godot_api::abi::AbiValueType::I64),
        ]
    {
    ...
    let output = state
        .call_method(
            &sum,
            &[
                godot_api::abi::AbiValueV1::from_i64(20),
                godot_api::abi::AbiValueV1::from_i64(0),
                godot_api::abi::AbiValueV1::from_i64(22),
            ],
        )
        .map_err(|error| {
            format!(
    ...
    if output.type_ != godot_api::abi::AbiValueType::I64 || output.payload[0] as i64 != 42 {
    ...
    if initial_counter.abi() != godot_api::abi::AbiValueV1::from_i64(3) {
        return Err("field `counter` did not expose its generated default".into());
    }
    state
        .set_field(&counter, godot_api::abi::AbiValueV1::from_i64(91))
        .map_err(|error| {
            format!(
    ...
    if updated_counter.abi() != godot_api::abi::AbiValueV1::from_i64(91) {
