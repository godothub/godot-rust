use godot_rs_api::abi::{AbiPtrcallType, AbiStatus, AbiValueType, AbiValueV1};
use godot_rs_api::{
...
impl NativeValue {
    ...
    pub(super) unsafe fn prepare_builtin_constructor(
        &mut self,
        interface: EngineInterface,
        variant_type: godot_rs_api::GDExtensionVariantType,
    ) -> Result<(), ValueError> {
        ...
        if variant_type == godot_rs_api::GDExtensionVariantType::GDEXTENSION_VARIANT_TYPE_NIL {
